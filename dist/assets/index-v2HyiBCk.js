 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oT(t){ZI(fs),os(new Rn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return tT(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),tn(su,iu,t),tn(su,iu,"esm2017")}Dt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Dt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};oT();const Uu=(t,e,n)=>{const s=za(Xo,i=>{s(),i?n():n("/auth")})},ks=Bm({history:Em("/finanzas-personales/"),routes:[{path:"/auth",name:"Auth",component:XI},{path:"/dashboard",name:"Dashboard",component:()=>tu(()=>import("./DashboardView-BV8f7w8q.js"),[]),beforeEnter:Uu},{path:"/transactions",name:"Transactions",component:()=>tu(()=>import("./AddTransactionsView-CzvAQ4Fl.js"),[]),beforeEnter:Uu}]}),bp=Vg(BI);bp.use(ks);bp.mount("#app");export{io as A,Ug as B,cT as C,_t as F,Ih as a,ts as b,Js as c,gh as d,_e as e,Ce as f,Vh as g,jh as h,Ca as i,GI as j,hT as k,za as l,Xo as m,Ta as n,Eh as o,Oi as p,lT as q,En as r,i_ as s,J as t,ot as u,_g as v,Di as w,uT as x,Jr as y,aT as z};
